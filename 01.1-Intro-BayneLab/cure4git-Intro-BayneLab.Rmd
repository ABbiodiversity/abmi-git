...
+ You may retain just 10% of what I talked about here today. That's okay. These slides will be available as a resource to you, and there are a ton of other resources out there to help. 
+ The important thing is to get off the sideline, accept the short period of pain, and try it out. Learning is done by doing.

+ If you want to work in a data science role, learning to use Git will be of huge value to you.
+ Decorate your Github profile page with some personal information (no one wants to hire a bar code). Pin the repositories with your best work. Show off your code.
+ Use Github to look at other people's code, learn from them, etc.
